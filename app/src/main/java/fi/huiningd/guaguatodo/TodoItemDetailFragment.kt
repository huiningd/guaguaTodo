...
import fi.huiningd.guaguatodo.data.DummyContent
...
class TodoItemDetailFragment : Fragment() {
     ...
     */
    //private var mItem: DummyContent.TodoItem? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val rootView = inflater.inflate(R.layout.todo_item_detail, container, false)

        // Show the dummy content as text in a TextView.
        mItem?.let {
            rootView.todoitem_detail.text = it.description
        }
